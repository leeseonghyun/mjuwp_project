...
module.exports = function(passport) {
  ...
  passport.use(new FacebookStrategy({
    ...
    clientID : '126832984675867',
    clientSecret : '25030e140021aedd2f4ba46f0b508d88',
    callbackURL : (process.env.node_EMV == 'production')? 'https://ancient-everglades-96484.herokuapp.com/': 'http://localhost:3000/auth/facebook/callback';
